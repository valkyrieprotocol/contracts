...
use valkyrie::test_constants::fund_manager::{fund_manager_env, MANAGING_TOKEN, CAMPAIGN_DEPOSIT_FEE_RECIPIENT};

use crate::executions::distribute_campaign_deposit_fee;
...
pub fn exec(
    ...
    distribute_campaign_deposit_fee(deps.as_mut(), env, info, amount)
}
...
fn succeed() {
    ...
    super::receive_campaign_deposit_fee::will_success(&mut deps, Uint128::new(50));
    ...
    assert_eq!(response.messages, vec![
        SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
            ...
            msg: to_binary(&Cw20ExecuteMsg::Transfer {
                recipient: CAMPAIGN_DEPOSIT_FEE_RECIPIENT.to_string(),
    ...
    assert_eq!(state.campaign_deposit_fee_amount, Uint128::zero());
    ...
    super::receive_campaign_deposit_fee::will_success(&mut deps, Uint128::new(100));
    ...
    let state = ContractState::load(&deps.storage).unwrap();
    assert_eq!(state.campaign_deposit_fee_amount, Uint128::new(50));
}
