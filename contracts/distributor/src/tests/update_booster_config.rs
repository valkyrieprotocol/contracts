...
use crate::tests::{governance_sender, DROP_BOOSTER_RATIO_PERCENT, ACTIVITY_BOOSTER_RATIO_PERCENT, PLUS_BOOSTER_RATIO_PERCENT};
...
fn succeed() {
    ...
    will_success(&mut deps, drop_booster_ratio, activity_booster_ratio, plus_booster_ratio);
